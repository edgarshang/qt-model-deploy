#ifndef YOLOV6_FACE_TENSORRT_H
#define YOLOV6_FACE_TENSORRT_H
...
class Yolov6_Face_TensorRT_Deploy : public ModelProcessor
{
public:
    Yolov6_Face_TensorRT_Deploy(modelConfInfo_ info);
    ~Yolov6_Face_TensorRT_Deploy();
    void get_model_info();
