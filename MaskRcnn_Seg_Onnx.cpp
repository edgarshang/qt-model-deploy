...
MaskRcnn_Seg_Onnx::MaskRcnn_Seg_Onnx(std::string modelPath, std::string imagePath, std::string label_text)
{
...
MaskRcnn_Seg_Onnx::~MaskRcnn_Seg_Onnx()
{
...
void MaskRcnn_Seg_Onnx::get_model_info()
{
...
cv::Mat MaskRcnn_Seg_Onnx::pre_image_process(cv::Mat &image)
{
...
void MaskRcnn_Seg_Onnx::run_model(cv::Mat &input_image)
{
...
void MaskRcnn_Seg_Onnx::post_image_process(std::vector<Ort::Value> &outputs, cv::Mat &inputimage)
{
...
void MaskRcnn_Seg_Onnx::process()
{
...
// show
void MaskRcnn_Seg_Onnx::set_Show_image(Show *imageShower)
{
    image_show = imageShower;
}

void MaskRcnn_Seg_Onnx::modelRunner()
{
    this->process();
}
