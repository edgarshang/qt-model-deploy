#ifndef MASKRCNN_SEG_TENSORRT_DEPLOY_H
#define MASKRCNN_SEG_TENSORRT_DEPLOY_H
...
class MaskRCNN_SEG_TensorRT_Deploy : public ModelProcessor
{
public:
    MaskRCNN_SEG_TensorRT_Deploy(modelConfInfo_ info);
    ~MaskRCNN_SEG_TensorRT_Deploy();
    void get_model_info();
...
#endif // MASKRCNN_SEG_TENSORRT_DEPLOY_H
