#ifndef YOLOV8_POSE_TENSORRT_H
#define YOLOV8_POSE_TENSORRT_H
...
class Yolov8_Pose_TensorRT_Deploy : public ModelProcessor
{
public:
    Yolov8_Pose_TensorRT_Deploy(modelConfInfo_ info);
    ~Yolov8_Pose_TensorRT_Deploy();
    void get_model_info();
