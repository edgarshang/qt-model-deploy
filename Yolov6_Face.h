#ifndef YOLOV6_FACE_H
#define YOLOV6_FACE_H
...
class Yolov6_Face : public ModelProcessor
{
public:
    Yolov6_Face(std::string modelPath, std::string imagePath, std::string label_text, std::string modelType);
    ~Yolov6_Face();
    void get_model_info();
