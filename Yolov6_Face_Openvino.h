#ifndef YOLOV6_FACE_OPENVINO_H
#define YOLOV6_FACE_OPENVINO_H
...
class Yolov6_Face_Openvino_Deploy : public ModelProcessor
{

public:
    Yolov6_Face_Openvino_Deploy(modelConfInfo_ info);
    ~Yolov6_Face_Openvino_Deploy();
    void get_model_info();
