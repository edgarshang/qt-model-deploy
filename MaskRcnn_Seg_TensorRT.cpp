#include "MaskRcnn_Seg_TensorRT.h"
...
MaskRCNN_SEG_TensorRT_Deploy::MaskRCNN_SEG_TensorRT_Deploy(modelConfInfo_ info)
{
...
MaskRCNN_SEG_TensorRT_Deploy::~MaskRCNN_SEG_TensorRT_Deploy()
{
...
void MaskRCNN_SEG_TensorRT_Deploy::get_model_info()
{
...
cv::Mat MaskRCNN_SEG_TensorRT_Deploy::pre_image_process(cv::Mat &image)
{
...
void MaskRCNN_SEG_TensorRT_Deploy::run_model(cv::Mat &input_image)
{
...
void MaskRCNN_SEG_TensorRT_Deploy::post_image_process(cv::Mat &inputimage)
{
...
void MaskRCNN_SEG_TensorRT_Deploy::modelStop()
{
    m_runingFlag = false;
}

void MaskRCNN_SEG_TensorRT_Deploy::process()
{
    labels = Common_API::readClassNames(label_path);
...
// show
void MaskRCNN_SEG_TensorRT_Deploy::set_Show_image(Show *imageShower)
{
    image_show = imageShower;
}

void MaskRCNN_SEG_TensorRT_Deploy::modelRunner()
{
    this->process();
}
