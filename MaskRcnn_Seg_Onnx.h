#ifndef MASKRCNN_SEG_ONNX_H
#define MASKRCNN_SEG_ONNX_H
...
class MaskRcnn_Seg_Onnx: public ModelProcessor
{
public:
    MaskRcnn_Seg_Onnx(std::string modelPath, std::string imagePath, std::string label_text);
    ~MaskRcnn_Seg_Onnx();
    void get_model_info();
