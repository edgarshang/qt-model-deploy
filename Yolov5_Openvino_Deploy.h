#ifndef YOLOV5_OPENVINO_DEPLOY_H
#define YOLOV5_OPENVINO_DEPLOY_H
...
class Yolov5_Openvino_Deploy : public ModelProcessor
{

public:
    Yolov5_Openvino_Deploy(modelConfInfo_ info);
    ~Yolov5_Openvino_Deploy();
    void get_model_info();
...
#endif // YOLOV5_OPENVINO_DEPLOY_H
