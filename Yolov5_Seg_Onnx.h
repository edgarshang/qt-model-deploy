#ifndef YOLOV5_SEG_ONNX_H
#define YOLOV5_SEG_ONNX_H
...
class Yolov5_Seg_Onnx : public ModelProcessor
{
public:
    Yolov5_Seg_Onnx(std::string modelPath, std::string imagePath, std::string label_text, std::string modelType);
    ~Yolov5_Seg_Onnx();
    void get_model_info();
