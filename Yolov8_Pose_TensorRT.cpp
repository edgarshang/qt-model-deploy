...
Yolov8_Pose_TensorRT_Deploy::Yolov8_Pose_TensorRT_Deploy(modelConfInfo_ info)
{
...
Yolov8_Pose_TensorRT_Deploy::~Yolov8_Pose_TensorRT_Deploy()
{
...
void Yolov8_Pose_TensorRT_Deploy::get_model_info()
{
...
cv::Mat Yolov8_Pose_TensorRT_Deploy::pre_image_process(cv::Mat &image)
{
...
void Yolov8_Pose_TensorRT_Deploy::run_model(cv::Mat &input_image)
{
...
void Yolov8_Pose_TensorRT_Deploy::modelStop()
{
    m_runingFlag = false;
}

void Yolov8_Pose_TensorRT_Deploy::process()
{
    labels = Common_API::readClassNames(label_path);
...
// show
void Yolov8_Pose_TensorRT_Deploy::set_Show_image(Show *imageShower)
{
    image_show = imageShower;
}

void Yolov8_Pose_TensorRT_Deploy::modelRunner()
{
    this->process();
}
