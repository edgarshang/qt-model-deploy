#ifndef KEYPOINTRCNN_H
#define KEYPOINTRCNN_H
...
class keyPointRcnn : public ModelProcessor
{
public:
    keyPointRcnn(std::string modelPath, std::string imagePath, std::string label_text, std::string modelType);
    ~keyPointRcnn();
    void get_model_info();
